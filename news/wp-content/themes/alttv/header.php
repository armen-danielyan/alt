...
<meta name="keywords" content="<?php echo 'ALT, TV, Armenia, online news, newspaper, Armavir, ԱԼՏ, հեռուստաընկերություն, Հայաստան, լրատվություն, լուրեր, Արմավիր, АЛТ, ТВ, Армения, интернет новости, Армавир' ?>" />
<?php endif; 
wp_reset_query(); ?>
...
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/fancybox/lib/jquery.mousewheel-3.0.6.pack.js"></script>
...
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/jquery.fancybox.pack.js?v=2.1.5"></script>

<!-- Optionally add helpers - button, thumbnail and/or media -->
<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/helpers/jquery.fancybox-buttons.css?v=1.0.5" type="text/css" media="screen" />
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/helpers/jquery.fancybox-media.js?v=1.0.6"></script>

<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7" type="text/css" media="screen" />
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/fancybox/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter19786015 = new Ya.Metrika({id:19786015,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/19786015" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
	<div id="scr">
		<div id="header">
			...
			<div id="informers">
				<div id="header-col1" class="header-cols">
					<a href="<?php bloginfo('home'); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/header_logo.png" width=116 height=64 /></a>
				</div>
